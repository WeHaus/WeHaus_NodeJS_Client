...
class Wehaus extends EventEmitter {
  ...
  get_mac_address() {
	...
	if(process.platform == 'linux'){
	  ...
	  let interface_name = 'Wi-Fi'; // May have to change this to work on your system. Kind of defeats the purpose...
	  let out = require('os').networkInterfaces()[interface_name][0].mac.trim();
	  console.log("Got Mac Address "+out);
	  this_.config.mac = out;
	}
  }
    ...
    rest.get(this.api_url('devices'), 
      ...
      .on('success', (data, response) => {
        this_.devices = data.filter((d) => {
          if (typeof d.remote_status != 'undefined') {
